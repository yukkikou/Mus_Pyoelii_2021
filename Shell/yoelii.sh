...
#SBATCH -o /home/hxy/log/Py_mRNA-%A_%a.out
#SBATCH -e /home/hxy/log/Py_mRNA-%A_%a.out
#SBATCH --mem 120G

#######################################################
gtf=/media/share/node13/disk3/ylab/hxy/Mus/annotation/P.yoelii/GCF_900002385.2_GCA_900002385_genomic_no_genes.gtf
genome=/media/share/node13/disk3/ylab/hxy/Mus/genome_ref/P.yoelii/GCF_900002385.2_GCA_900002385_genomic.fna
